import {
  ...
  SeasonBillingRateViewDto, LookupDetailDto
...
import {
  CREATE_FARMER_URI, GET_FARMERS_URI, GET_BRANCH_URI, GET_LOOKUP_DETAILS_URI, GET_SUBHGL_URI, UPDATE_FARMER_URI, GET_BILLPARAMSFORCATEGORY_URI,
  GET_GETSEASONBILLINGRATES_URI, CURRENT_SEASON_URI, GET_LOOKUP_DETAILS_FOR_MENU_URI, GET_FARMER_URI
...
export class AppMasterService extends ApiHttpService {
  ...
  public GetFarmer(farmerId: number) {
    return this.getWithId<FarmersViewDto[]>(GET_FARMERS_URI, farmerId);
  }
