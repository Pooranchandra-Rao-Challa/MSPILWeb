...
import { BillDto, BillParameterDto, BillParameterViewDto, BillViewDto, DieselBunkDto, DieselBunkViewDto } from "../_models/billingmaster";
import { ApiHttpService } from "./api.http.service";
import { CREATE_BILLPARAM_URI, CREATE_BILL_URI, CREATE_DIESELBUNK_URI, GET_BILLPARAMS_URI, GET_BILLS_URI, GET_DIESEL_BUNK_URI, UPDATE_BILLPARAM_URI, UPDATE_BILL_URI,
  UPDATE_DIESELBUNK_URI } from "./api.uri.service";
