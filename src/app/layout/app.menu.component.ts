     ...
     */
      {
        ...
        items: [
          ...
          },
          {
            ...
            permission: true,
            items: [
              { label: 'Plot Offer', icon: 'pi pi-fw pi-circle', routerLink: ['/monitoring/plotoffer'], permission: this.jwtService.Permissions.CanViewAllottedPlots },
              ...
              { label: 'Plot Report Approval', icon: 'pi pi-fw pi-circle', routerLink: ['/monitoring/plotoffer/:forapproval'], permission: this.jwtService.Permissions.CanViewAllottedPlots },
              // { label: 'Plot Assesment', icon: 'pi pi-fw pi-circle', routerLink: ['/monitoring/plotassesment'], permission: true },
