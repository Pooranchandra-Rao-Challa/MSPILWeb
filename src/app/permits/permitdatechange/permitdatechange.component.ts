...
@Component({
    selector: 'app-permitdatechange',
    templateUrl: './permitdatechange.component.html',
    styles: [],
  })
  export class PermitDateChangeComponent implements OnInit {
    fbPermitDateChange!: FormGroup;
    seasons!: any[];
    ...
    constructor(private formbuilder: FormBuilder,
      ...
      getFilterPermitDateChange() {
        this.fbPermitDateChange = this.formbuilder.group({
      ...
      get FormControals() {
        return this.fbPermitDateChange.controls
      }
      initSeasons() {
      ...
      ngOnInit(): void {
        this.getFilterPermitDateChange();
        this.initSeasons();
